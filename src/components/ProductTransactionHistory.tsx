        ...
        ListHeaderComponent={
          <View>
            ...
            <View style={styles.stockSummaryCard}>
              <Text style={styles.stockSummaryLabel}>
                Current stock
              </Text>
              ...
              <Text style={styles.stockSummaryDescription}>
                Based on the latest recorded inventory transaction
              </Text>
            </View>
          </View>
        }
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyDescription}>
              Stock movements for this product will appear here.
            </Text>
          </View>
        }
        renderItem={({ item }) => {
  ...
  return (
    <View style={styles.timelineRow}>
        ...
        <View
          style={[
            ...
            display.isPositive
              ? styles.positiveDot
              : styles.negativeDot,
            display.isNeutral && styles.neutralDot,
          ]}
        />
      ...
      <View style={styles.transactionCard}>
          ...
          <Text
            style={[
              ...
              display.isPositive
                ? styles.positiveText
                : styles.negativeText,
              display.isNeutral && styles.neutralText,
            ]}
          >
        ...
        <View style={styles.stockMovementRow}>
...
function groupTransactionsByDate(
  ...
  transactions.forEach((transaction) => {
    const sectionTitle = getDateSectionTitle(
      transaction.createdAt,
    );

    const existingGroup = groups.get(sectionTitle) ?? [];

    existingGroup.push(transaction);
    groups.set(sectionTitle, existingGroup);
  });
...
function getDateSectionTitle(
  ...
  if (
    transactionDay.getTime() === yesterday.getTime()
  ) {
    return "Yesterday";
  }
...
function formatSource(
  source: TransactionHistoryItem["source"],
): string {
  switch (source) {
    case "camera":
      return "Camera";
...
function getTransactionDisplay(
  ...
  switch (transaction.transactionType) {
    case "stock_in":
      return {
        title: "Stock In",
        quantityText: `+${transaction.quantity}`,
        isPositive: true,
        isNeutral: false,
      };
    ...
    default:
      return {
        ...
        quantityText: transaction.quantity.toString(),
        isPositive: false,
        isNeutral: true,
      };
  }
