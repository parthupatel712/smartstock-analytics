...
const TRANSACTION_OPTIONS: TransactionOption[] = [
  ...
  },
  {
    ...
    description: "Remove stock after a sale.",
  },
  {
    type: "return",
    label: "Customer Return",
    description: "Add returned stock back.",
  },
  {
    type: "damage",
    label: "Damage",
    description: "Remove damaged or expired stock.",
  },
  {
    type: "adjustment",
    label: "Physical Count",
    description: "Set stock to the counted quantity.",
  },
];
...
export function InventoryTransactionForm({
  ...
  const selectedOption = useMemo(
    () =>
      TRANSACTION_OPTIONS.find(
        (option) => option.type === transactionType,
  ...
  function validateQuantity(): number | null {
    if (quantity.trim() === "") {
      setErrorMessage(`${quantityLabel} is required.`);
      return null;
    }
    ...
    if (
      ...
      parsedQuantity > product.currentStock
    ) {
      setErrorMessage(
  ...
  async function handleSubmit(): Promise<void> {
    ...
    const parsedQuantity = validateQuantity();
              ...
              {TRANSACTION_OPTIONS.map((option) => {
                ...
                return (
                  <Pressable
                    ...
                    key={option.type}
                    onPress={() => {
                      setTransactionType(option.type);
                      setQuantity("");
                      setErrorMessage("");
...
function getStockImpactMessage(
  ...
  switch (transactionType) {
    case "stock_in":
    case "return":
      return `${currentStock} → ${currentStock + quantity} units`;
